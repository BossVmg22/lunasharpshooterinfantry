  ...
  return (
    <>
      ...
      <section style={heroStyle}>
        ...
        <div className="hero-content" style={{ position: 'relative', zIndex: 1, padding: '0 48px', maxWidth: 860 }} className="hero-content">
          ...
          <div style={{ marginBottom: 32 }}>
            <Typewriter
              text={content.hero_tagline ?? 'Discipline is our strength. Precision is our legacy.'}
              speed={40}
              loop
              loopDelay={3000}
              style={{ fontFamily: 'Source Serif 4,serif', fontSize: 15, fontWeight: 300, color: 'var(--text)', lineHeight: 1.8, maxWidth: 520, fontStyle: 'italic' }}
            />
          </div>
      ...
      <section style={{ background: 'var(--bg2)', borderBottom: '1px solid var(--border)' }}>
        <div className="container" style={{ padding: '16px 40px' }}>
          <AnnouncementTicker items={announcements} interval={6000} />
        </div>
      </section>
